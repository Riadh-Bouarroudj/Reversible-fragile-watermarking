...
def TIFF_save(watermarked_img):
   imageio.imwrite("C:/Users/HP/Desktop/Doctorat/Codes/Images/image.tiff", watermarked_img, format="tiff")
   TIFF_img = imageio.imread("C:/Users/HP/Desktop/Doctorat/Codes/Images/image.tiff")
...
def PNG_save(watermarked_img):
   ...
   pil_image.save("C:/Users/HP/Desktop/Doctorat/Codes/Images/image.png")
   png_img = imageio.imread('C:/Users/HP/Desktop/Doctorat/Codes/Images/image.png')
...
def JPEG_save(watermarked_img,qual):
   pil_image = Image.fromarray(watermarked_img)
   pil_image.save("C:/Users/HP/Desktop/Doctorat/Codes/Images/image.jpg","JPEG",quality=qual)   
   jpeg_img = imageio.imread('C:/Users/HP/Desktop/Doctorat/Codes/Images/image.jpg')  
...
def Copy_paste_attack(watermarked_img,XD, YD,sizex, sizey):
   image=np.copy(watermarked_img)
   img = imageio.imread('C:/Users/HP/Desktop/Doctorat/Codes/Images/Peppers.tiff')
...
def Content_addition(watermarked_img,des_x, des_y ,sizex,sizey):
   image=np.copy(watermarked_img)
   img = imageio.imread('C:/Users/HP/Desktop/Doctorat/Codes/Images/Addition.png')
...
def Content_only_attack(type,watermarked_img,XD, YD,xsize, ysize,MSB):
   image=np.copy(watermarked_img)
   pic = imageio.imread('C:/Users/HP/Desktop/Doctorat/Codes/Images/Peppers.tiff')
